...
insert into Student value(0, 'S科11','2000-02-02');
insert into Student value(1, 'S222','2000-02-03');
insert into Student value(2, 'S333','2008-01-30');
insert into Student value(3, 'S444','2019-01-01');
insert into Student value(4, 'S555','1905-01-01');
insert into Student value(5, 'super juan','2002-01-01');
...
insert into SC value(0, 1, null, 2);
...
insert into SC value(5, 0, 100, 1);
insert into SC value(5, 1, 100, 1);
insert into SC value(5, 2, 100, 1);
insert into SC value(5, 3, 100, 1);
insert into SC value(5, 4, 100, 1);
